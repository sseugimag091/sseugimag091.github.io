const pages = [
    {
        characters: [{ src: '../static/chat.png' }],
        speaker: '',
        dialogue: '당분간은 밖에 나가지 말고, 집 안에 있으라는 걱정이 담긴 메시지다. 나람 하제의 대화 내용일까?'
    },
    {
        characters: [{ src: '../static/chat.png' }],
        speaker: '노나',
    ...
    },
    {
        characters: [{ src: '../static/chat.png' }],
        speaker: '???',
        dialogue: '스토커 붙은거 맞지? 질이 좀 나빠 보이는데.'
    },
    {
        characters: [{ src: '../static/chat.png' }],
        speaker: '하제',
        dialogue: '하루이들 일도 아니고, 괜찮을거야.'
    },
    {
        characters: [{ src: '../static/chat.png' }],
        speaker: '???',
        dialogue: '그래도 혹시 모르니까 웬만하면 밖에 나가지 말고 안에 있어.'
    },
    {
        characters: [{ src: '../static/chat.png' }],
        speaker: '하제',
        dialogue: '내가 애도 아니고... 알았어. 너무 걱정하지 마.)'
    },
];
